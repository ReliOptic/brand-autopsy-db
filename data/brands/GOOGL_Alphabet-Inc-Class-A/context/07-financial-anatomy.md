...
|----------|-------------|-------------|
| 10-K (Annual Report) | FY2025 | [SEC EDGAR — GOOGL 10-K](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001652044&type=10-K&dateb=&owner=include&count=10) |
| 10-Q (Quarterly Report) | Latest | [SEC EDGAR — GOOGL 10-Q](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001652044&type=10-Q&dateb=&owner=include&count=10) |
| DEF 14A (Proxy Statement) | FY2025 | [SEC EDGAR — GOOGL DEF 14A](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001652044&type=DEF+14A&dateb=&owner=include&count=10) |
| 8-K (Material Events) | Rolling | [SEC EDGAR — GOOGL 8-K](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001652044&type=8-K&dateb=&owner=include&count=20) |
...
|-------------|---------|------------|--------|
| FY2025 | $402.8B | +15.1% | (SEC 10-K FY2025) |
| FY2024 | $350.0B | +13.9% | (SEC 10-K FY2024) |
| FY2023 | $307.4B | +8.7% | (SEC 10-K FY2023) |
| FY2022 | $282.8B | +9.8% | (SEC 10-K FY2022) |
| FY2021 | $257.6B | +41.2% | (SEC 10-K FY2021) |
| FY2020 | $182.5B | +12.8% | (SEC 10-K FY2020) |
| FY2019 | $161.9B | — | (SEC 10-K FY2019) |

> **Source**: SEC EDGAR XBRL companyfacts API — [CIK 0001652044](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001652044&type=10-K&dateb=&owner=include&count=10)

### 2.2 Revenue Context

Based on public SEC filings, Alphabet Inc. (Class A) operates in the **Interactive Media &amp; Services** segment within the **Communication Services** sector. Revenue composition details, including segment and geographic breakdowns, are disclosed in the company's 10-K filing under Notes to Financial Statements (T1_OFFICIAL). Refer to the EDGAR filing linked above for the most current segment disclosure.
...
|--------|------|------|------|--------|
| Operating Margin | 32.0% | 32.1% | 27.4% | (SEC 10-K) |
| Net Margin | 32.8% | 28.6% | 24.0% | (SEC 10-K) |
...
_Share repurchase and dividend data not available in EDGAR XBRL._
...
| Item | Value | Source |
|------|-------|--------|
| Total Assets | $595.3B | (SEC 10-K FY2025) |
...
>  Expenditures by advertisers tend to correlate with overall economic conditions. Adverse macroeconomic conditions have affected, and may in the future affect, the demand for advertising, resulting in fluctuations in the amounts
...
|-----------------|---------------|---------------------------|
| Revenue Trend | +15.1% YoY (FY2025) | Growth momentum supports brand investment |
| Net Income (FY2025) | $132.2B | Positive net income provides headroom for brand and marketing investment |
...
1. **All GOOGL Filings**: [https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001652044&type=10-K&dateb=&owner=include&count=40)](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001652044&type=10-K&dateb=&owner=include&count=40)
2. **XBRL Viewer**: [https://www.sec.gov/cgi-bin/viewer?action=view&cik=1652044&type=10-K](https://www.sec.gov/cgi-bin/viewer?action=view&cik=1652044&type=10-K)
3. **Company Facts API**: [https://data.sec.gov/api/xbrl/companyfacts/CIK0001652044.json](https://data.sec.gov/api/xbrl/companyfacts/CIK0001652044.json)
