# 08. Legal Review — Regions Financial Corporation (RF)
...
|----------|----------|-------------|
| 10-K — Part I, Item 1A (Risk Factors) | Legal & regulatory risks | [SEC EDGAR RF](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&company=Regions+Financial+Corporation&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany) |
| 10-K — Part I, Item 3 (Legal Proceedings) | Active litigation disclosures | Same 10-K, Item 3 |
| 8-K Filings | Material legal events | [SEC EDGAR RF 8-K](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&company=Regions+Financial+Corporation&CIK=&type=8-K&dateb=&owner=include&count=20&search_text=&action=getcompany) |
...
Regions Financial Corporation maintains a trademark portfolio protecting its brand names, product names, and logos in relevant commercial classes. Trademark registrations are publicly searchable via the USPTO TESS database and equivalent international registries. (T1_OFFICIAL, USPTO public records)

### 2.2 Patent Portfolio

Regions Financial Corporation's patent portfolio reflects its R&D investment in regional banks technology and processes. Patent grants and applications are publicly searchable via USPTO and Google Patents. The company's 10-K filing describes its intellectual property strategy in general terms. (SEC 10-K; T1_OFFICIAL, USPTO records)

---

## 3. Major Litigation

> All descriptions below are factual summaries of publicly disclosed legal proceedings as referenced in Regions Financial Corporation's SEC filings.

Regions Financial Corporation's active litigation and legal proceedings are disclosed in the company's 10-K, Part I, Item 3 (Legal Proceedings) and in the Notes to Financial Statements under Commitments and Contingencies. (SEC 10-K)
...
Regions Financial Corporation's regulatory environment reflects the requirements applicable to regional banks within financials. Key regulatory areas as typically disclosed in the 10-K include:
...
**Assessment**: Based on publicly available records, Regions Financial Corporation's litigation posture reflects standard commercial practices for a company of its size in the financials sector. (T4_INFERRED)
...
### 5.4 Writing Risk Guide — Regions Financial Corporation
...
Regions Financial Corporation's ESG disclosures are available in the company's sustainability report, proxy statement (DEF 14A), and 10-K filing. Key areas include:
...
Refer to Regions Financial Corporation's 10-K Item 1A for company-specific risk factor disclosure.
```
...
**Overall Project Risk Level for Regions Financial Corporation Content: MEDIUM-HIGH**
