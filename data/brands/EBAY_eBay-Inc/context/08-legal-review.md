...
|----------|----------|-------------|
| 10-K — Part I, Item 1A (Risk Factors) | Legal & regulatory risks | [SEC EDGAR EBAY](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&company=eBay+Inc.&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany) |
| 10-K — Part I, Item 3 (Legal Proceedings) | Active litigation disclosures | Same 10-K, Item 3 |
| 8-K Filings | Material legal events | [SEC EDGAR EBAY 8-K](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&company=eBay+Inc.&CIK=&type=8-K&dateb=&owner=include&count=20&search_text=&action=getcompany) |
...
eBay Inc. maintains a trademark portfolio protecting its brand names, product names, and logos in relevant commercial classes. Trademark registrations are publicly searchable via the USPTO TESS database and equivalent international registries. (T1_OFFICIAL, USPTO public records)

### 2.2 Patent Portfolio

eBay Inc.'s patent portfolio reflects its R&D investment in broadline retail technology and processes. Patent grants and applications are publicly searchable via USPTO and Google Patents. The company's 10-K filing describes its intellectual property strategy in general terms. (SEC 10-K; T1_OFFICIAL, USPTO records)

---

## 3. Major Litigation

> All descriptions below are factual summaries of publicly disclosed legal proceedings as referenced in eBay Inc.'s SEC filings.

eBay Inc.'s active litigation and legal proceedings are disclosed in the company's 10-K, Part I, Item 3 (Legal Proceedings) and in the Notes to Financial Statements under Commitments and Contingencies. (SEC 10-K)
...
eBay Inc.'s regulatory environment reflects the requirements applicable to broadline retail within consumer discretionary. Key regulatory areas as typically disclosed in the 10-K include:
...
**Assessment**: Based on publicly available records, eBay Inc.'s litigation posture reflects standard commercial practices for a company of its size in the consumer discretionary sector. (T4_INFERRED)
...
### 5.4 Writing Risk Guide — eBay Inc.
...
eBay Inc.'s ESG disclosures are available in the company's sustainability report, proxy statement (DEF 14A), and 10-K filing. Key areas include:
...
Refer to eBay Inc.'s 10-K Item 1A for company-specific risk factor disclosure.
```
...
**Overall Project Risk Level for eBay Inc. Content: MEDIUM**
