# 08. Legal Review — Chipotle Mexican Grill (CMG)
...
|----------|----------|-------------|
| 10-K — Part I, Item 1A (Risk Factors) | Legal & regulatory risks | [SEC EDGAR CMG](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&company=Chipotle+Mexican+Grill&CIK=&type=10-K&dateb=&owner=include&count=10&search_text=&action=getcompany) |
| 10-K — Part I, Item 3 (Legal Proceedings) | Active litigation disclosures | Same 10-K, Item 3 |
| 8-K Filings | Material legal events | [SEC EDGAR CMG 8-K](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&company=Chipotle+Mexican+Grill&CIK=&type=8-K&dateb=&owner=include&count=20&search_text=&action=getcompany) |
...
Chipotle Mexican Grill maintains a trademark portfolio protecting its brand names, product names, and logos in relevant commercial classes. Trademark registrations are publicly searchable via the USPTO TESS database and equivalent international registries. (T1_OFFICIAL, USPTO public records)

### 2.2 Patent Portfolio

Chipotle Mexican Grill's patent portfolio reflects its R&D investment in restaurants technology and processes. Patent grants and applications are publicly searchable via USPTO and Google Patents. The company's 10-K filing describes its intellectual property strategy in general terms. (SEC 10-K; T1_OFFICIAL, USPTO records)

---

## 3. Major Litigation

> All descriptions below are factual summaries of publicly disclosed legal proceedings as referenced in Chipotle Mexican Grill's SEC filings.

Chipotle Mexican Grill's active litigation and legal proceedings are disclosed in the company's 10-K, Part I, Item 3 (Legal Proceedings) and in the Notes to Financial Statements under Commitments and Contingencies. (SEC 10-K)
...
Chipotle Mexican Grill's regulatory environment reflects the requirements applicable to restaurants within consumer discretionary. Key regulatory areas as typically disclosed in the 10-K include:
...
**Assessment**: Based on publicly available records, Chipotle Mexican Grill's litigation posture reflects standard commercial practices for a company of its size in the consumer discretionary sector. (T4_INFERRED)
...
### 5.4 Writing Risk Guide — Chipotle Mexican Grill
...
Chipotle Mexican Grill's ESG disclosures are available in the company's sustainability report, proxy statement (DEF 14A), and 10-K filing. Key areas include:
...
Refer to Chipotle Mexican Grill's 10-K Item 1A for company-specific risk factor disclosure.
```
...
**Overall Project Risk Level for Chipotle Mexican Grill Content: MEDIUM**
